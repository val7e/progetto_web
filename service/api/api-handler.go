...
func (rt *_router) Handler() http.Handler {
	...
	rt.router.PUT("/users/me/pic", rt.wrap(rt.setMyPic))
	...
	rt.router.DELETE("/groups/:group_id/leave", rt.wrap(rt.leaveGroup))
	...
	rt.router.DELETE("/conversations/:conversation_id/messages/:message_id/comments", rt.wrap(rt.uncommentMessage))
